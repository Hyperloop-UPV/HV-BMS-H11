...
public:
    ...
    static void high_voltage_system_init(float &voltage_min, float &voltage_max, float &temp_min, float &temp_max, float &current_reading, float &voltage_reading, float &batteries_voltage_reading, nested_sm_status &nested_sm_status)
    {
        high_voltage_system_packet = new HeapPacket(static_cast<uint16_t>(950), &voltage_min, &voltage_max, &temp_min, &temp_max, &current_reading, &voltage_reading, &batteries_voltage_reading, &nested_sm_status);
    }
    ...
    static void HVBMS_GSM_init(gsm_status &gsm_status)
    {
        HVBMS_GSM_packet = new HeapPacket(static_cast<uint16_t>(954), &gsm_status);
    }
    ...
    inline static HeapPacket *HVBMS_GSM_packet{nullptr};
    ...
    static void start()
    {
        ...
        if (HVBMS_GSM_packet == nullptr) {
            PANIC("Packet HVBMS_GSM not initialized");
        }
        ...
        Scheduler::register_task(50000, +[](){
            ...
            DataPackets::control_station_udp->send_packet(*DataPackets::HVBMS_GSM_packet);
