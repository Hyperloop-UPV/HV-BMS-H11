...
public:
    ...
    static void FAULT_init() { FAULT_order = new HeapOrder(0, &FAULT_cb); }
    ...
    static void bypass_imd_init() { bypass_imd_order = new HeapOrder(904, &bypass_imd_cb); }
...
private:
    static void FAULT_cb() { FAULT_flag = true; }
    static void open_contactors_cb() { open_contactors_flag = true; }
    static void start_precharge_cb() { start_precharge_flag = true; }
    static void bypass_imd_cb() { bypass_imd_flag = true; }
};
