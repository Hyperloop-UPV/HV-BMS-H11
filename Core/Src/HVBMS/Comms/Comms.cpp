...
void Comms::start() {
    ...
    DataPackets::battery_2_init(
        ...
        Sensors::battery_h11.battery[1].cells[4], Sensors::battery_h11.battery[1].cells[5],
    ...
    DataPackets::battery_4_init(
        ...
        Sensors::battery_h11.battery[3].cells[4], Sensors::battery_h11.battery[3].cells[5],
    ...
    DataPackets::battery_6_init(
        ...
        Sensors::battery_h11.battery[5].cells[4], Sensors::battery_h11.battery[5].cells[5],
    ...
    DataPackets::battery_8_init(
        ...
        Sensors::battery_h11.battery[7].cells[4], Sensors::battery_h11.battery[7].cells[5],
    ...
    DataPackets::batteries_data_init(Batteries::get_min_voltage(), Batteries::get_max_voltage(),
