...
using myBoard =
    ST_LIB::Board<eth, led_PG7, led_PG8, contactor_PG14, contactor_PG12,
                  contactor_PD4, contactor_PF4, sdc_PA11, adc_PF13, adc_PA0,
                  timer_us_tick_def, bms_spi3, bms_cs_pin>;
...
int main(void) {
  ...
  TimerWrapper<timer_us_tick_def> us_timer =
      get_timer_instance(myBoard, timer_us_tick_def);
